...
{
    ui->setupUi(this);
    setWindowTitle("MOTIMATE");
    setWindowIcon(QIcon("C:/Users/legen/Downloads/Muscle.png"));
    ...
    connect(shortcut1, &QShortcut::activated, this, &MainWindow::on_P1plus_clicked);
    QShortcut *shortcut2 = new QShortcut(QKeySequence(Qt::Key_2), this);
    connect(shortcut2, &QShortcut::activated, this, &MainWindow::on_P2plus_clicked);
}
...
void MainWindow::on_ConfirmButton_clicked()
{
    ...
    ui->P1plus->setText(player1Name);
    ui->P2plus->setText(player2Name);
    ...
    if (!amount.toInt(&ok)) {
        ...
        QMessageBox::warning(this, "Invalid Amount", "Please enter a valid integer for the Amount.");
        ui->AmountBox->clear(); // Clear the AmountBox to prompt for re-entry
